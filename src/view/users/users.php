  ...
  <div class="beheren-flex">
    ...
    <div class="gebruiker-form">
      <form class="form-grid" action="index.php?page=users" method="post">
        ...
        <p>Vul alle velden in om een gebruiker aan te maken.</p>
        ...
        <?php if (!empty($_GET['id'])) { ?>
          <div class="form-password-update">
            ...
            <input class="toggle-zichtbaar toggle-wachtwoord" id="updatepassword" type="checkbox" name="updatepassword" />
          </div>
        <?php } ?>
        <div class="display-password display-toggle <?php echo !empty($_GET['id']) ? "hidden" : ""; ?>">
          <div class="form-grid-items">
            <label for="password">Wachtwoord</label>
            <input id="password" class="input-wachtwoord" type="password" name="password" placeholder="Wachtwoord" minlength="3" maxlength="64" <?php echo empty($_GET['id']) ? "required" : ""; ?> />
          </div>
        </div>
        <div class="form-grid-items">
